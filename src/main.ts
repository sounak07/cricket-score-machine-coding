...
const driver = () => {
    ...
    const Innings1Score: GameScore = Innings1.MatchInnings([["1", "1", "1", "1", "1", "2"], ["W", "4", "4", "Wd", "W", "1", "6"]], ["P1", "P2", "P3", "P4", "P5"],["B1", "B2", "B3", "B4", "B5"]);
    const Innings2Score: GameScore = Innings2.MatchInnings([["4", "6", "W", "W", "1", "1"], ["6", "1", "W", "W"]], ["P6", "P7", "P8", "P9", "P10"], ["B6", "B7", "B8", "B9", "B10"]);
